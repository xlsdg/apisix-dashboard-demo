...
import { createLoadingSelector, dispatches as RoutesDispatches } from '@/redux/actions/routes';
...
const Header = React.memo(props => {
  ...
  const left = (
    <Breadcrumb>
      ...
      <Breadcrumb.Item>{formatMessage({ id: 'dashboard.routes.new' })}</Breadcrumb.Item>
    </Breadcrumb>
  );
...
function mapDispatchToProps(dispatch, ownProps) {
  return {
    ...
    ...RoutesDispatches(dispatch, ['addRecord']),
  };
}
