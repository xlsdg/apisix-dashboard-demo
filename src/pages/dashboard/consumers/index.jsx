...
import { createStateSelector, createDispatchSelector } from '@/redux/actions/consumers';
...
const Header = React.memo(props => {
  ...
  const left = (
    <Breadcrumb>
      ...
      <Breadcrumb.Item>{formatMessage({ id: 'dashboard.consumers.menu' })}</Breadcrumb.Item>
    </Breadcrumb>
  );

  const handleClick = React.useCallback(() => history.push('/dashboard/consumers/add'), []);
  const right = (
