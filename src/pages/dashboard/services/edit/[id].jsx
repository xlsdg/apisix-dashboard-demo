...
import { createStateSelector, createLoadingSelector, dispatches as ServicesDispatches } from '@/redux/actions/services';
...
const Header = React.memo(props => {
  ...
  const left = (
    <Breadcrumb>
      ...
      <Breadcrumb.Item>{formatMessage({ id: 'dashboard.services.edit' })}</Breadcrumb.Item>
    </Breadcrumb>
  );
...
function mapDispatchToProps(dispatch, ownProps) {
  return {
    ...
    ...ServicesDispatches(dispatch, ['editRecord']),
  };
}
